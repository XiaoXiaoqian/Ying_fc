function extract_TR_data_maint_raw_78(sub,run)
...
%localizer
   ...
   all_data_final_maint=zeros(size(all_data.img,1),size(all_data.img,2),size(all_data.img,3),12);
    ...
    filename=sprintf('%s/sub%02d/analysis/run%d_singletrial.feat/Extracted_maint_TR_2standard_raw_78.nii',basedir,sub,run);
